...
* The dotted 45-degree line corresponds to a random classifier. Since all three models (logistic regression, CART 1 and CART 2) are above the diagonal, their predictionis **better** than random. 
...
* To maximize profit, we would select the point which shows the highest estimated profit. For CART 1 and CART 2 this would be around 20%, for log reg it would be around 35%.

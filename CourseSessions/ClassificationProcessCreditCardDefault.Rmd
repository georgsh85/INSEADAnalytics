...
* For example, let's look at the US missile defense system: when the model predicts with a 99% probabilit threshold that the country is under attack, it sends a response strike, as this is a major event.

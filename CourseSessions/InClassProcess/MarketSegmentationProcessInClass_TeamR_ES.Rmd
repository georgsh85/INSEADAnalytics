...
* The first individual (Obs1) seems to be driven by trends, prestige and adventure (factors 2,4,3) and care less about price, DIY-repairs and functionality (factors 5,6,9). The second individual (Obs2) values trends, prestige, expert opinion (factors 2,4,10), and cares less about shopping around, sports and price (factors 7,14,5). The third individual (Obs3) wants to have the latest-greatest and willing to pay a premium for it (factors 2,13), and bothers much less than average about functionality, DIY-repair, shopping around for deals and price (factors 9, 5-7). Obs10 shows a very different profile that values rather passion, adverture and good price for a basic boat (factors 3,5,1) and does not follow, research or pays premium for brands factors 7,8,13).

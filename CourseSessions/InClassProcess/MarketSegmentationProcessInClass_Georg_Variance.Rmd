...
<!-- **Note:** Assuming the working directory is "MYDIRECTORY/INSEADAnalytics" (where you have cloned the course material), you can create an html file by running in your console the command rmarkdown::render("CourseSessions/InClassProcess/MarketSegmentationProcessInClass_Georg_Variance.Rmd") -->
...
# Please use numbers, not column names, e.g. c(1:5, 7, 8) uses columns 1,2,3,4,5,7,8
# segmentation_attributes_used = c(28,19,15,8,5,12,11,9,2,30) #c(10,19,5,12,3) # based on variance threshold 65
segmentation_attributes_used = c(28,15,20,8,3,12,2,5,9,11,30,25,6,27) #c(10,19,5,12,3)

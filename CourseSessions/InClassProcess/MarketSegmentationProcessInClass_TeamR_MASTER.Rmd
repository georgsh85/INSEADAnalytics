...
* We would like to see a few components that explain a very high percentage of variance. This way, we can reduce the complexity of the segmentation without loosing too much information.

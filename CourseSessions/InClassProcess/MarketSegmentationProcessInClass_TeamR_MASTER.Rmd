...
* Looking at the questions that have high loadings for component 1, we find a similarity of interests: #9 "I see my boat as a status symbol", #26 *Having a powerful boat is what is most important to me*, #3 *The brand of boat I buy says a lot about who I am* and #13 *When buying a boat, I tend to buy the latest and greatest*. The "message" across all of these questions is aligned and differs from those that have high loadings in component 2: #18 *Boating gives me a feeling of adventure* #21 *Boating helps me to escape from everyday life and relax* and #19 *Boating allows me to experience nature*. It can be very well imagined that people answering high for the questions contributing to component 1 will be looking at different boats than those answering high for the questions contributing to component 2. This definitely makes business sense.
* The number of factors to be chosen is already indicated above and might be based on these statistical aspects. Furthermore, it is useful to choose factors in such a way that each attribute/question contributes only to one or a few factors (few high loadings per row) and that the attributes with high loadings differ significantly across the factors. This will help with interpreting the factors. Last but not least, a business only can handle a certain amount of complexity (cost benefit analysis) and, hence, a large number of factors should be avoided.

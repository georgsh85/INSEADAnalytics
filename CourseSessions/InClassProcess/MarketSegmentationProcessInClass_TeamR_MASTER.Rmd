...
* In cases with very high correlation it might not be important to use both questions, instead one could reduce complexity by dropping one of them or calculating the average response.

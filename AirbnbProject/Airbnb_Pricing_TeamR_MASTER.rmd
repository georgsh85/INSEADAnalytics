...
Iterating our model and tweaking the analysis process, we chose to segment the data. For instance, we thought about the incidence of "reviews" on price: in fact, places which have never been booked will be priced less accurately than "mature" properties on the market.

...
We split the data into an estimation sample and two validation samples - using randomized splitting technique. We chose the split to be 90% estimation, 5% validation, and 5% test data, depending on the number of observations.


In our case we used 18000 observations before initial screening, which left us with 12,000 - we then split the remaining 12,000 data points into estimation 10,800, 100 validation data, and 100 test data.

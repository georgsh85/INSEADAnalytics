...
We will exclude data from neighborhoods that are not at least represented with `r cutoff.neighborhood` listings.

```{r}
table(PricingData.estimation$neighborhood)
```
